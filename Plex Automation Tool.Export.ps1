...
<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       8/12/2016 3:20 PM
...
#region File Recovery Data (DO NOT MODIFY)
<#RecoveryData:
#>
#endregion
	#----------------------------------------------
	...
	$7ZipTextBox = New-Object 'System.Windows.Forms.TextBox'
	$Python27TextBox = New-Object 'System.Windows.Forms.TextBox'
	$7Zipcheckbox = New-Object 'System.Windows.Forms.CheckBox'
	$Python27checkbox = New-Object 'System.Windows.Forms.CheckBox'
	$groupbox1 = New-Object 'System.Windows.Forms.GroupBox'
	$HtpcManagerTextBox = New-Object 'System.Windows.Forms.TextBox'
	$PlexRequestsTextBox = New-Object 'System.Windows.Forms.TextBox'
	$PlexEmailTextBox = New-Object 'System.Windows.Forms.TextBox'
	$PlexPyTextBox = New-Object 'System.Windows.Forms.TextBox'
	$JackettTextBox = New-Object 'System.Windows.Forms.TextBox'
	$CouchPotatoTextBox = New-Object 'System.Windows.Forms.TextBox'
	$SonarrTextBox = New-Object 'System.Windows.Forms.TextBox'
	...
	$buttonInstall_Click={
		...
		If ($7Zipcheckbox.Checked -eq $true){
			...
			Else
			{
				If (($7ZipTextBox.Text | Measure-Object).count -gt 0)
				{
					$Global:7ZipInstallPath = $7ZipTextBox.Text
				}
				
				
				Install-Software -Filepath $7ZipSavePath `
								 -Arguments "/S /D=`"$Global:7ZipInstallPath`"" `
								 -Software 7Zip
		...
		If ($Python27checkbox.Checked -eq $true){
			...
			Else
			{
				If (($Python27TextBox.Text | Measure-Object).count -gt 0){
					$Global:Python27InstallPath = $Python27TextBox.Text
				}
				
				Install-Software -Filepath $Python27SavePath `
								 -Arguments "/QN /norestart TARGETDIR=$Global:Python27InstallPath" `
								 -Software 'Python 2.7'
		...
		If ($SonarrCheckBox.Checked -eq $true) {
			...
			Else
			{
				If (($SonarrTextBox.Text | Measure-Object).count -gt 0)
				{
					$Global:SonarrInstallpath = $SonarrTextBox.Text
				}
				
				Install-Software -Filepath $SonarrSavePath `
								 -Arguments "/Silent /DIR=`"$Global:SonarrInstallpath`"" `
								 -Software Sonarr
		...
		If ($CouchPotatoCheckBox.Checked -eq $true)	{
			...
			Else
			{
				If (($CouchPotatoTextBox.Text | Measure-Object).count -gt 0)
				{
					$Global:CPInstallPath = $CouchPotatoTextBox.Text
				}
							
				Install-Software -Filepath $CouchPotatoSavepath `
								 -Arguments "/Silent /DIR=`"$Global:CPInstallPath`"" `
								 -Software CouchPotato
		...
		If ($JackettCheckBox.Checked -eq $true){
			...
			Else
			{
				If (($JackettTextBox.Text | Measure-Object).count -gt 0)
				{
					$Global:JackettInstallPath = $JackettTextBox.Text
				}
				
				Install-Software -Filepath $JackettSavepath `
								 -Arguments "/VERYSILENT /DIR=`"$Global:JackettInstallPath`"" `
								 -Software Jackett
		...
		If ($PlexPyCheckBox.Checked -eq $true){
			...
			Else
			{
				If (($PlexPyTextBox.Text | Measure-Object).count -gt 0)
				{
					$Global:PlexPyInstallPath = $PlexPyTextBox.Text
				}
				...
				&$Global:7ZipExe x $PlexPySavepath "-o$Global:PlexPyInstallPath" -y
		...
		If ($PlexEmailCheckBox.Checked -eq $true){
			...
			Else
			{
				If (($PlexEmailTextBox.Text | Measure-Object).count -gt 0)
				{
					$Global:PlexEmailInstallPath = $PlexEmailTextBox.Text
				}
				...
				&$Global:7ZipExe x $PlexEmailSavepath "-o$Global:PlexEmailInstallPath" -y
		...
		If ($PlexRequestsCheckBox.Checked -eq $true){
			...
			Else
			{
				If (($PlexRequestsTextBox.Text | Measure-Object).count -gt 0)
				{
					$Global:PlexRequestsInstallPath = $PlexRequestsTextBox.Text
				}
				...
				&$Global:7ZipExe x $PlexRequestsSavepath "-o$Global:PlexRequestsInstallPath" -y
		...
		If ($HTPCManagerCheckBox.Checked -eq $true)	{
			...
			Else
			{
				If (($HTPCManagerTextBox.Text | Measure-Object).count -gt 0)
				{
					$Global:HTPCManagerInstallPath = $HTPCManagerTextBox.Text
				}
				...
				&$Global:7ZipExe x $HTPCManagerSavepath "-o$Global:HTPCManagerInstallPath" -y
	...
	$Form_StoreValues_Closing=
	{
		...
		$script:MainForm_7ZipTextBox = $7ZipTextBox.Text
		$script:MainForm_Python27TextBox = $Python27TextBox.Text
		$script:MainForm_7Zipcheckbox = $7Zipcheckbox.Checked
		$script:MainForm_Python27checkbox = $Python27checkbox.Checked
		$script:MainForm_HtpcManagerTextBox = $HtpcManagerTextBox.Text
		$script:MainForm_PlexRequestsTextBox = $PlexRequestsTextBox.Text
		$script:MainForm_PlexEmailTextBox = $PlexEmailTextBox.Text
		$script:MainForm_PlexPyTextBox = $PlexPyTextBox.Text
		$script:MainForm_JackettTextBox = $JackettTextBox.Text
		$script:MainForm_CouchPotatoTextBox = $CouchPotatoTextBox.Text
		$script:MainForm_SonarrTextBox = $SonarrTextBox.Text
	...
	# groupbox2
	#
	$groupbox2.Controls.Add($7ZipTextBox)
	$groupbox2.Controls.Add($Python27TextBox)
	$groupbox2.Controls.Add($7Zipcheckbox)
	$groupbox2.Controls.Add($Python27checkbox)
	$groupbox2.Location = '12, 12'
	$groupbox2.Name = 'groupbox2'
	$groupbox2.Size = '513, 98'
	$groupbox2.TabIndex = 11
	$groupbox2.TabStop = $False
	$groupbox2.Text = 'Select PreReqs To Install                       Select Path to Install (Optional)'
	#
	# 7ZipTextBox
	#
	$7ZipTextBox.Location = '229, 62'
	$7ZipTextBox.Name = '7ZipTextBox'
	$7ZipTextBox.Size = '278, 23'
	$7ZipTextBox.TabIndex = 5
	#
	# Python27TextBox
	#
	$Python27TextBox.Location = '229, 32'
	$Python27TextBox.Name = 'Python27TextBox'
	$Python27TextBox.Size = '278, 23'
	$Python27TextBox.TabIndex = 4
	#
	# 7Zipcheckbox
	#
	...
	# groupbox1
	#
	$groupbox1.Controls.Add($HtpcManagerTextBox)
	$groupbox1.Controls.Add($PlexRequestsTextBox)
	$groupbox1.Controls.Add($PlexEmailTextBox)
	$groupbox1.Controls.Add($PlexPyTextBox)
	$groupbox1.Controls.Add($JackettTextBox)
	$groupbox1.Controls.Add($CouchPotatoTextBox)
	$groupbox1.Controls.Add($SonarrTextBox)
	...
	$groupbox1.Size = '513, 259'
	$groupbox1.TabIndex = 10
	$groupbox1.TabStop = $False
	$groupbox1.Text = 'Select Software to Install                          Select Path to Install (Optional)'
	#
	# HtpcManagerTextBox
	#
	$HtpcManagerTextBox.Location = '228, 226'
	$HtpcManagerTextBox.Name = 'HtpcManagerTextBox'
	$HtpcManagerTextBox.Size = '278, 23'
	$HtpcManagerTextBox.TabIndex = 17
	#
	# PlexRequestsTextBox
	#
	$PlexRequestsTextBox.Location = '228, 197'
	$PlexRequestsTextBox.Name = 'PlexRequestsTextBox'
	$PlexRequestsTextBox.Size = '278, 23'
	$PlexRequestsTextBox.TabIndex = 16
	#
	# PlexEmailTextBox
	#
	$PlexEmailTextBox.Location = '228, 168'
	$PlexEmailTextBox.Name = 'PlexEmailTextBox'
	$PlexEmailTextBox.Size = '278, 23'
	$PlexEmailTextBox.TabIndex = 15
	#
	# PlexPyTextBox
	#
	$PlexPyTextBox.Location = '228, 138'
	$PlexPyTextBox.Name = 'PlexPyTextBox'
	$PlexPyTextBox.Size = '278, 23'
	$PlexPyTextBox.TabIndex = 14
	#
	# JackettTextBox
	#
	$JackettTextBox.Location = '228, 109'
	$JackettTextBox.Name = 'JackettTextBox'
	$JackettTextBox.Size = '278, 23'
	$JackettTextBox.TabIndex = 13
	#
	# CouchPotatoTextBox
	#
	$CouchPotatoTextBox.Location = '228, 51'
	$CouchPotatoTextBox.Name = 'CouchPotatoTextBox'
	$CouchPotatoTextBox.Size = '278, 23'
	$CouchPotatoTextBox.TabIndex = 11
	#
	# SonarrTextBox
	#
	$SonarrTextBox.Location = '229, 22'
	$SonarrTextBox.Name = 'SonarrTextBox'
	$SonarrTextBox.Size = '278, 23'
	$SonarrTextBox.TabIndex = 10
	#
	# HTPCManagerCheckBox
	#
	...
	$HTPCManagerCheckBox.Size = '287, 24'
	...
	$PlexRequestsCheckBox.Size = '288, 24'
	...
	$CouchPotatoCheckBox.Size = '288, 24'
